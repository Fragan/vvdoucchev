...
public class AddressActionPanel extends javax.swing.JPanel  {
    ...
    public void setBSaveEnable(boolean activated) {
		btnSaveAddress.setEnabled(activated);
	}
    
    public void setBDeleteEnable(boolean activated) {
		btnDeleteAddress.setEnabled(activated);
	}
