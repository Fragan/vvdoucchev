...
public class AddressPanel extends javax.swing.JPanel {
	...
	/**
	 * Ajoute un KeyListener sur les elements Lastname, Firstname, Middlename, Email 
	 */
	public void addKeyListeners(KeyListener keyListener) {
		txtFirstName.addKeyListener(keyListener);
		txtLastName.addKeyListener(keyListener);
		txtMiddleName.addKeyListener(keyListener);
