 ...
 * <ul>
 *   <li>{@link topology.impl.DimensionImpl#getSize <em>Size</em>}</li>
 *   <li>{@link topology.impl.DimensionImpl#isIsCircular <em>Is Circular</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DimensionImpl extends EObjectImpl implements Dimension {
	...
	protected EClass eStaticClass() {
		return TopologyPackage.Literals.DIMENSION;
	}
	...
	public void setSize(int newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TopologyPackage.DIMENSION__SIZE, oldSize, size));
	}
	...
	public void setIsCircular(boolean newIsCircular) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TopologyPackage.DIMENSION__IS_CIRCULAR, oldIsCircular, isCircular));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TopologyPackage.DIMENSION__SIZE:
				return getSize();
			case TopologyPackage.DIMENSION__IS_CIRCULAR:
				return isIsCircular();
		}
