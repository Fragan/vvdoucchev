...
public class TopologyFactoryImpl extends EFactoryImpl implements TopologyFactory {
	...
	public static TopologyFactory init() {
		try {
			TopologyFactory theTopologyFactory = (TopologyFactory)EPackage.Registry.INSTANCE.getEFactory("http://topology/1.01.0"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case TopologyPackage.DIMENSION: return createDimension();
			default:
