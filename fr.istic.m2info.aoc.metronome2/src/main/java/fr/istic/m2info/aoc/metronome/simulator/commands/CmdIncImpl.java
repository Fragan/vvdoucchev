 ...
 * @version 1.0
 */
public class CmdIncImpl implements EventButtonManager {
	 ...
	 * keyboard
	 */
	public CmdIncImpl(Hardware hardware) {
		this.hardware = hardware;
	}

	/**
	 * Met l'etat du bouton INC a active
	 */
	public void executeOnClick() {
		hardware.getKeyBoard().setKeyState(Keyboard.INC, true);
	}

	/**
	 * Met l'etat du bouton INC a desactive
	 */
	public void executeOnRelease() {
		hardware.getKeyBoard().setKeyState(Keyboard.INC, false);
	}
